...
TOP_LEVEL_NAME="Altera_unique_chip_ID"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/Altera_unique_chip_ID/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altchip_id/altchip_id.v" -work Altera_unique_chip_ID -cdslib ./cds_libs/Altera_unique_chip_ID.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Altera_unique_chip_ID.v"                                                                             
fi
