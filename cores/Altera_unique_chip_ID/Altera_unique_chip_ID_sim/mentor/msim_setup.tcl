...
# ----------------------------------------
# If Altera_unique_chip_ID is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2018.03.18.21:25:40
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "Altera_unique_chip_ID"
}
...
ensure_lib                       ./libraries/Altera_unique_chip_ID/
vmap       Altera_unique_chip_ID ./libraries/Altera_unique_chip_ID/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altchip_id/altchip_id.v" -work Altera_unique_chip_ID
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Altera_unique_chip_ID.v"                            
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L Altera_unique_chip_ID -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L Altera_unique_chip_ID -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver $TOP_LEVEL_NAME
}
