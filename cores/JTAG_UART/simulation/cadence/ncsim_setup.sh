...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/JTAG_UART_jtag_uart.v"       -work jtag_uart      -cdslib ./cds_libs/jtag_uart.cds.lib     
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/JTAG_UART.v"                                                                                          
fi
